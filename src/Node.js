...
class Node {
    ...
    deleteValue(value){
        ...
        if(value === this.value){
            ...
            var initialLeftSpacing = this.leftNode.cumulativeRightSpacing
                ...
                // Add this value to the left half of the tree
                var shiftedNode = this.leftNode.deleteValue(value);
                ...
                var shiftedNode = this.rightNode.deleteValue(value);
    ...
    searchByPos(x, y) {
       var dx=x-this.x;
        ...
        // console.log('val:'+this.value+'x: '+x+' y: '+y+' thisx:'+ this.x+' thisy:'+this.y);
        if (!this.isFilled()) {
            return null;
            ...
            var leftVal= this.leftNode.searchByPos(x,y);
            var rightVal= this.rightNode.searchByPos(x,y);
            if(leftVal!=null)
                return leftVal;
            if(rightVal!=null)
                return rightVal;
